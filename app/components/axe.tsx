...
type GLTFResult = GLTF & {
    ...
    materials: {
        wire_115115115: THREE.MeshStandardMaterial;
    };
};
...
const Axe = (props: Props) => {
    const { nodes } = useGLTF("/models/Axe/scene.gltf") as GLTFResult;
...
useGLTF.preload("/models/Axe/scene.gltf");
export default Axe;
